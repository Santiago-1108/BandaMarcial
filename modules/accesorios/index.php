...
$sql = "SELECT * FROM accesorios WHERE 1=1";
$params = [];
...
try {
    ...
    $stmt_nombres = $conn->query("SELECT DISTINCT nombre FROM accesorios ORDER BY nombre");
...
<div class="main-content">
    <div class="header-actions">
        ...
        <div class="btn-group">
            <a href="crear.php" class="btn btn-success">Agregar Accesorio</a>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="6" class="no-results-cell">
                        No se encontraron accesorios con los filtros aplicados.
                    </td>
                </tr>
                <?php else: ?>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($accesorio['codigo_serie']); ?></td>
                    <td>
                        <span class="estado estado-<?php echo strtolower(str_replace(' ', '-', $accesorio['estado'])); ?>">
                            <?php echo $accesorio['estado']; ?>
                        </span>
                    </td>
                    <td><?php echo htmlspecialchars($accesorio['observaciones']); ?></td>
                    <td><?php echo date('d/m/Y', strtotime($accesorio['fecha_registro'])); ?></td>
                    <td>
                        <div class="table-actions">
                            <a href="editar.php?id=<?php echo $accesorio['id']; ?>" class="btn btn-warning">Editar</a>
                            <a href="eliminar.php?id=<?php echo $accesorio['id']; ?>" class="btn btn-danger" onclick="return confirmarEliminacion('¿Está seguro de eliminar este accesorio?')">Eliminar</a>
                        </div>
                    </td>
                </tr>
                <?php endforeach; ?>
    ...
    <div class="text-small text-muted">
        <strong>Total de accesorios:</strong> <?php echo count($accesorios); ?>
    </div>
</div>
